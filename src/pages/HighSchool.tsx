...
const HighSchool: React.FC = () => {
  ...
  const completedLevels = [1]; // Example: only level 1 is completed
      ...
      <main className="flex-1 container mx-auto p-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="rounded-xl overflow-hidden shadow-xl mb-8">
            <img src="/lovable-uploads/6f034866-9aa1-4b95-a121-9b3a6d46fbf0.png" alt="High school students with technology" className="w-full h-auto max-h-[40vh] object-contain" />
          </div>
          
          <p className="text-center mb-8">Advanced computer science topics and project-based learning for teenagers.</p>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-4 max-w-3xl mx-auto">
              {Array.from({
              length: 6
            }, (_, i) => <LearningLevel key={i + 1} level={i + 1} maxLevel={6} ageGroup="teen" isCompleted={completedLevels.includes(i + 1)} />)}
            </div>
          </div>
        </div>
      </main>
